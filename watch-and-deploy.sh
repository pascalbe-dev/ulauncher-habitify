...
export VERBOSE=1 
export ULAUNCHER_WS_API=ws://127.0.0.1:5054/ulauncher-habitify 
export PYTHONPATH=/usr/lib/python3/dist-packages 

startExtension() {
    /usr/bin/python3 $HOME/.local/share/ulauncher/extensions/ulauncher-habitify/main.py >> /tmp/ulauncher-extension.log 2>&1 &
    pid=$(echo $!)
}
